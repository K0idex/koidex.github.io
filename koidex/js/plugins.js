...
(function ($, window, document, undefined) {
  ...
  OnePageNav.prototype = {
    ...
    adjustNav: function (self, $parent) {
      ...
      var e = $(".skcode_topbar .menu .current a");
    ...
    scrollTo: function (target, callback) {
      ...
      var topbar = jQuery(".skcode_topbar").outerHeight();

      if (jQuery(".skcode_topbar").length) {
        $("html, body").animate(
          {
...
window.onload = function () {
  ...
  css.type = "text/css";
  css.innerHTML = ".txt-rotate > .wrap { border-right: 0.08em solid #A0A0A0 }";
